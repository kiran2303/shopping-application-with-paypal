...
import com.trupti_prajapati.retailapp.view.adapter.ProductOverViewPagerAdapter;
import com.trupti_prajapati.retailapp.view.fragment.ProductListFragment;
...
public class ProductLoaderTask extends AsyncTask<String, Void, Void> {
	...
	protected Void doInBackground(String... params) {
		...
		WebServer.getFakeWebServer().getAllElectronics();
