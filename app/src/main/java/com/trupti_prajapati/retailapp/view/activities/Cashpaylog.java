...
public class Cashpaylog extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(Cashpaylog.this, "Email cannot be empty!", Toast.LENGTH_SHORT).show();

                } else if (strpwd.isEmpty())

                {
                    Toast.makeText(Cashpaylog.this, "Password cannot be empty", Toast.LENGTH_SHORT).show();
...
//                    String URL = "http://www.vnurture.in/pro/login.php";
                    ...
                    new WebserviceCall(Cashpaylog.this, URL, jsonRequest, "Loading...", true, new AsyncResponse() {
                        @Override
                        public void onCallback(String response) {
                            ...
                            if (pojologin.getStatus()==1)
                            {
                                ...
                                Intent i = new Intent(Cashpaylog.this,Payment.class);
                                startActivity(i);
                            }
        ...
        lsignup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent in=new Intent(getApplicationContext(),Cashpayregistration.class);
                startActivity(in);
                        ...
                        new WebserviceCall(Cashpaylog.this, URL, jsonRequest, "Loading...", true, new AsyncResponse() {
                            ...
                            public void onCallback(String response) {
                                ...
                                if (pf.getStatus()==1)
                                {
                                    ...
                                    Intent i = new Intent(Cashpaylog.this,ECartHomeActivity.class);
                                    startActivity(i);
                                }
